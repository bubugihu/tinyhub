    ...
    public function run()
    {
        DB::table('category')->insert([
            ...
            [   'category_name'     =>  'On Ear',
                ...
                'description'       =>  'On-ear headphones rest on your ears. They are smaller and lighter than over-ear headphones, making it easy to carry around. Ambient noise is still audible to a limited extent, making on-ear headphones safer in traffic.',
            ],
